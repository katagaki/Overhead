...
extension JREastLineData {
    ...
    static let jobanRapid = StaticTrainLine(
        ...
        directions: [
            direction("JobanRapid", "Toride", "取手方面", "For Toride", ascending: true,
                      weekday: pattern("04:55", "23:45", [
                          ("04:55", 8), ("06:30", 5), ("09:30", 7), ("16:30", 6), ("20:00", 8), ("22:00", 10),
                      ], .rapid),
                      holiday: pattern("04:55", "23:45", [
                          ("04:55", 8), ("07:00", 6), ("10:00", 7), ("20:00", 8), ("22:00", 10),
                      ], .rapid)),
            direction("JobanRapid", "Ueno", "上野方面", "For Ueno", ascending: false,
                      weekday: pattern("04:40", "23:30", [
                          ("04:40", 8), ("06:00", 5), ("09:30", 7), ("16:30", 6), ("20:00", 8), ("22:00", 10),
                      ], .rapid),
                      holiday: pattern("04:40", "23:30", [
    ...
    static let jobanLocal = StaticTrainLine(
        ...
        directions: [
            direction("JobanLocal", "Toride", "取手方面", "For Toride", ascending: true,
                      weekday: pattern("04:40", "23:50", [
                          ("04:40", 8), ("07:00", 4), ("09:30", 8), ("16:30", 5), ("20:00", 8), ("22:00", 10),
                      ]),
                      holiday: pattern("04:40", "23:50", [
    ...
    static let yokosukaSobu = StaticTrainLine(
        id: "odpt.Railway:JR-East.YokosukaSobu",
        nameJa: "横須賀・総武線快速",
    ...
    static let tokaido = StaticTrainLine(
        ...
        directions: [
            direction("Tokaido", "Atami", "小田原・熱海方面", "For Odawara & Atami", ascending: true,
                      weekday: pattern("04:50", "23:20", [
                          ("04:50", 10), ("06:30", 5), ("09:30", 9), ("16:30", 7), ("20:00", 10), ("22:00", 12),
                      ]),
                      holiday: pattern("04:50", "23:20", [
                          ("04:50", 10), ("07:00", 7), ("10:00", 9), ("20:00", 11),
                      ])),
            direction("Tokaido", "Tokyo", "東京方面", "For Tokyo", ascending: false,
                      weekday: pattern("04:40", "23:00", [
                          ("04:40", 10), ("06:00", 5), ("09:30", 9), ("16:30", 7), ("20:00", 10), ("22:00", 12),
                      ]),
                      holiday: pattern("04:40", "23:00", [
                          ("04:40", 10), ("07:00", 7), ("10:00", 9), ("20:00", 11),
                      ])),
        ],
        delayInfo: delayInfo,
        throughServices: [
            through("Tokaido", "Tokyo", .descending,
                    ...
                    "宇都宮線・高崎線・常磐線方面", "for the Utsunomiya, Takasaki & Joban Lines"),
    ...
    static let shonanShinjuku = StaticTrainLine(
        ...
        directions: [
            direction("ShonanShinjuku", "Omiya", "新宿・大宮方面", "For Shinjuku & Omiya", ascending: true,
                      weekday: pattern("06:00", "22:40", [
                          ("06:00", 12), ("07:00", 8), ("09:30", 14), ("16:30", 10), ("20:00", 15),
                      ], .rapid),
                      holiday: pattern("06:00", "22:40", [
                          ("06:00", 12), ("08:00", 10), ("10:00", 13), ("20:00", 15),
                      ], .rapid)),
        ...
        throughServices: [
            through("ShonanShinjuku", "Omiya", .ascending,
                    "宇都宮線・高崎線", "JR Utsunomiya & Takasaki Lines",
                    "宇都宮・高崎方面", "for Utsunomiya & Takasaki"),
    ...
    static let utsunomiya = StaticTrainLine(
        ...
        stations: [
            ...
            st("Utsunomiya", "Kurihashi", "栗橋", "Kurihashi", "", 36.1198, 139.6958),
        ...
        directions: [
            direction("Utsunomiya", "Utsunomiya", "宇都宮方面", "For Utsunomiya", ascending: true,
                      weekday: pattern("05:10", "22:50", [
                          ("05:10", 15), ("06:30", 8), ("09:30", 14), ("16:30", 10), ("20:00", 14), ("22:00", 18),
                      ]),
                      holiday: pattern("05:10", "22:50", [
                          ("05:10", 15), ("07:00", 10), ("10:00", 13), ("20:00", 15),
                      ])),
            direction("Utsunomiya", "Tokyo", "上野・東京方面", "For Ueno & Tokyo", ascending: false,
                      weekday: pattern("04:40", "22:30", [
                          ("04:40", 15), ("06:00", 8), ("09:30", 14), ("16:30", 10), ("20:00", 14), ("22:00", 18),
                      ]),
                      holiday: pattern("04:40", "22:30", [
                          ("04:40", 15), ("07:00", 10), ("10:00", 13), ("20:00", 15),
                      ])),
        ],
        delayInfo: delayInfo,
        throughServices: [
    ...
    static let nambu = StaticTrainLine(
        ...
        directions: [
            direction("Nambu", "Tachikawa", "立川方面", "For Tachikawa", ascending: true,
                      weekday: pattern("04:50", "23:50", [
                          ("04:50", 8), ("06:30", 4.5), ("09:30", 7), ("16:30", 6), ("20:00", 8), ("22:00", 10),
                      ]),
                      holiday: pattern("04:50", "23:50", [
                          ("04:50", 8), ("07:00", 6), ("10:00", 7.5), ("20:00", 9),
                      ])),
    ...
    static let musashino = StaticTrainLine(
        ...
        stations: [
            ...
            st("Musashino", "HigashiMatsudo", "東松戸", "Higashi-Matsudo", "JM13", 35.7578, 139.9327),
    ...
    static let ome = StaticTrainLine(
        ...
        directions: [
            direction("Ome", "Ome", "青梅方面", "For Ome", ascending: true,
                      weekday: pattern("04:55", "24:05", [
                          ("04:55", 10), ("06:30", 6), ("09:30", 11), ("16:30", 8), ("20:00", 10), ("22:00", 14),
                      ]),
                      holiday: pattern("04:55", "24:05", [
                          ("04:55", 10), ("07:00", 8), ("10:00", 10), ("20:00", 12),
                      ])),
            direction("Ome", "Tachikawa", "立川方面", "For Tachikawa", ascending: false,
                      weekday: pattern("04:45", "23:55", [
                          ("04:45", 10), ("06:00", 6), ("09:30", 11), ("16:30", 8), ("20:00", 10), ("22:00", 14),
                      ]),
                      holiday: pattern("04:45", "23:55", [
                          ("04:45", 10), ("07:00", 8), ("10:00", 10), ("20:00", 12),
                      ])),
        ],
        delayInfo: delayInfo,
        throughServices: [
