...
private func st(_ op: String, _ line: String, _ suffix: String, _ ja: String, _ en: String,
                _ code: String, _ lat: Double, _ lon: Double) -> Station {
    Station(
        id: "odpt.Station:\(op).\(line).\(suffix)",
...
private func direction(_ op: String, _ line: String, _ suffix: String, _ ja: String, _ en: String,
                       ascending: Bool,
                       weekday: ServicePattern, holiday: ServicePattern) -> StaticLineDirection {
    StaticLineDirection(
        id: "static.RailDirection:\(op).\(line).\(suffix)",
        nameJa: ja, nameEn: en,
...
private func through(_ op: String, _ line: String, _ junctionSuffix: String, _ end: ThroughService.LineEnd,
                     _ lineJa: String, _ lineEn: String,
                     _ towardJa: String, _ towardEn: String) -> ThroughService {
    ThroughService(
        junctionStationId: "odpt.Station:\(op).\(line).\(junctionSuffix)",
        end: end,
